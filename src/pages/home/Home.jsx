    ...
    <div className="home-page">
      ...
      <div className="two-column flex-between parent-container-padding">
        <div style={{ position:"relative" }}>
          ...
          <h1>
            Spread love and joy, one card at a time
          </h1>
          <p>
            Whether it’s a special occasion or just because, our group greeting cards are the perfect way to brighten someone’s day.
          </p>
      ...
      <div className="ready-to-use-section parent-container-padding">
        <div className="two-column flex-between">
          <div>
            ...
            <p>
              Choose from our beautiful collection of card templates, edit it to fit your taste and add a personal touch at no extra cost.
            </p>
            <Link>Explore Cards <i className="ri-arrow-right-up-line"></i></Link>
          </div>
          <img src={image} alt="" />
        </div>
      </div>
      ...
      <div className="spread-love-section parent-container-padding">
        <div className="two-column flex-between" style={{ flexDirection:"row-reverse" }}>
          <div>
            <h1>
              Spread the love with endless messages!
            </h1>
            <p>
              Share your card with unlimited recipients and gather their heartfelt words for an unforgettable experience.
            </p>
            <Link>Share a card <i class="ri-arrow-right-up-line"></i></Link>
          </div>
          <img src={image} alt="" />
        </div>
      </div>
      ...
      <div className="parent-container-padding get-started-steps-section">
        <div className="header">
          <h1>
            Here’s how to get started with spreading love on heartfelt.
          </h1>
          <Link>Get started for free <i className="ri-arrow-right-up-line"></i></Link>
        </div>
        <div className="body grid-3 g-6">
          <div>
            <h1>1</h1>
            <h3>Customise card</h3>
            <p>Select a card design that suits the occasion and personalize it with your unique message.</p>
          </div>
          <div>
            <h1>2</h1>
            <h3>Share with others</h3>
            <p>Share with others Extend your invitation by sharing the card link and inviting others to sign.</p>
          </div>
          <div>
            <h1>3</h1>
            <h3>Sit back and relax</h3>
            <p>We’ll handle the delivery of your group e-card straight to the recipient’s email at the set date and time.</p>
          </div>
        </div>
      </div>
        ...
        <div className="body">
          <div className="flex-between-start">
            ...
            <div className="top-body">
              ...
              <h1>
                Supporting the life of people around the world.
              </h1>
              <p>
                A portion of every card that is purchased helps save a life through our partnership with the non-profit organisation.
              </p>
              <div>
                <h2>30K</h2>
          ...
          <div className="flex-between-start bottom-body">
            <div>
              ...
              <h2>95%</h2>
              <p>of the world’s population has felt the helping hands, and we saved lives with every gift card that you share! </p>
            </div>
