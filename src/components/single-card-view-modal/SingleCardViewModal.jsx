  ...
  return (
    <div className="single_card_view_modal" ref={card_view_modal}>
      ...
      <div className="view_modal_buttons">
        <button className="modal_save_changes"><i className='bx bxs-file-blank'></i>Save Changes</button>
        <button className="modal_cancel_changes" onClick={close_card_view_modal}><i className='bx bxs-x-circle'></i>Cancel</button>
      </div>
    </div>
  )
}
